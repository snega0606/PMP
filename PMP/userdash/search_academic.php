...
$s = mysqli_query($con, "SELECT DISTINCT year FROM records");
?>
<style>
...
<br>
            <center><a href="dashboard.php" class="fcc-btn">Back</a><br>
  <br></center>
        </form></center>
        <div class="container my-5">
            <table class="table">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $sql="select * from records where year like '%$search%'";
